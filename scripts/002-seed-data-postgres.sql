...
('m1n2o3p4-q5r6-7890-abcd-ef1234567902', 'Project Manager - Construction', 'project-manager-construction', 'Construction', 'Kolwezi, DRC', 'full-time', 'senior', 'We are seeking an experienced Project Manager to oversee our construction projects in the Kolwezi region.', '["Bachelor''s degree in Civil Engineering or Construction Management", "Minimum 5 years of project management experience", "Proven track record of delivering projects on time and within budget"]', '["Plan and execute construction projects", "Manage budgets and timelines", "Coordinate with stakeholders", "Ensure compliance with safety standards"]', TRUE),
('n1o2p3q4-r5s6-7890-abcd-ef1234567903', 'Heavy Equipment Operator', 'heavy-equipment-operator', 'Operations', 'Kolwezi, DRC', 'full-time', 'mid', 'Experienced heavy equipment operators needed for mining and construction projects.', '["Valid heavy equipment operator license", "Minimum 3 years of experience with excavators and bulldozers", "Knowledge of safety protocols"]', '["Operate heavy machinery safely and efficiently", "Perform routine maintenance checks", "Report equipment issues promptly"]', TRUE),
('o1p2q3r4-s5t6-7890-abcd-ef1234567904', 'Logistics Coordinator', 'logistics-coordinator', 'Logistics', 'Lubumbashi, DRC', 'full-time', 'mid', 'Coordinate transportation and supply chain operations for our logistics division.', '["Bachelor''s degree in Logistics or related field", "3+ years of logistics experience", "Knowledge of DRC transportation regulations"]', '["Manage transportation schedules", "Coordinate with suppliers", "Track shipments", "Optimize delivery routes"]', TRUE);

-- ============================================
-- SITE SETTINGS
-- ============================================
INSERT INTO site_settings (id, setting_key, setting_value, setting_type, description) VALUES
('p1q2r3s4-t5u6-7890-abcd-ef1234567905', 'company_name', 'KMS SARL', 'text', 'Company display name'),
('q1r2s3t4-u5v6-7890-abcd-ef1234567906', 'company_email', 'info@kmssarl.org', 'text', 'Primary contact email'),
('r1s2t3u4-v5w6-7890-abcd-ef1234567907', 'company_phone', '+243 XXX XXX XXX', 'text', 'Primary contact phone'),
('s1t2u3v4-w5x6-7890-abcd-ef1234567908', 'company_address', 'Kolwezi, Lualaba Province, Democratic Republic of Congo', 'text', 'Company headquarters address'),
('t1u2v3w4-x5y6-7890-abcd-ef1234567909', 'hero_title', 'Building Tomorrow''s Congo Today', 'text', 'Homepage hero section title'),
('u1v2w3x4-y5z6-7890-abcd-ef1234567910', 'hero_subtitle', 'Premier construction, mining support, and logistics services in the Democratic Republic of Congo', 'text', 'Homepage hero section subtitle');